...
export default function TextBlock({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: 'focus:outline-none min-h-[200px] px-4 py-3 text-zinc-900 dark:text-zinc-50',
      },
    },
  });
  ...
  }, [editor, isEditing, block.content, onUpdate]);
      ...
      {isEditing ? (
        <div className="space-y-3 pr-20">
          ...
          <div className="flex flex-wrap gap-1 rounded-t-lg border border-b-0 border-zinc-300 bg-zinc-50 p-2 dark:border-zinc-700 dark:bg-zinc-800">
            ...
            <button
              ...
              className="rounded bg-white px-2 py-1 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-100 disabled:opacity-50 dark:bg-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-600"
              title="Rückgängig"
            >
              ↶
            </button>
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="rounded bg-zinc-200 px-3 py-1.5 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-300 dark:bg-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-600"
            >
              Abbrechen
            </button>
          </div>
        ...
        >
          {block.content ? (
            ...
            <p className="text-zinc-500 dark:text-zinc-400">Klicken zum Bearbeiten</p>
          )}
        </div>
      )}
    </BaseBlock>
